                    ...
                    <tr>
                        ...
                        <td>
                            <div class="d-flex">
                                ...
                                <div>
                                    <form action="<?php echo e(route('employees.destroy', ['employee' => 1])); ?>" method="POST"><?php echo csrf_field(); ?> <?php echo method_field('delete'); ?>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="d-flex">
                                ...
                                <div>
                                    <form action="<?php echo e(route('employees.destroy', ['employee' => 2])); ?>" method="POST"> <?php echo csrf_field(); ?> <?php echo method_field('delete'); ?>
                                        <button type="submit" class="btn btn-outline-dark btn-sm me-2"><i class="bi-trash"></i></button>
                                    </form>
                                </div>
                            </div>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="d-flex">
                                ...
                                <div>
                                    <form action="<?php echo e(route('employees.destroy', ['employee' => 3])); ?>" method="POST"> <?php echo csrf_field(); ?> <?php echo method_field('delete'); ?>
                                        <button type="submit" class="btn btn-outline-dark btn-sm me-2"><i class="bi-trash"></i></button>
                                    </form>
                                </div>
                            </div>
