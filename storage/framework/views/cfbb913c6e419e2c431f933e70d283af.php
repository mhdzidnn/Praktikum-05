...
<body>
    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <hr class="d-lg-none text-white-50"><a href="<?php echo e(route('profile')); ?>" class="btn btn-outline-light my-2 ms-md-auto"><i class="bi-person-circle me-1"></i>
                My Profile</a>
        </div>
    </div>
    </nav>
...
<?php /**PATH C:\Users\Dell\LaravelPraktikum5\resources\views/profile.blade.php ENDPATH**/ ?>